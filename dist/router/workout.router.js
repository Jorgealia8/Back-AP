...
workoutRouter.patch('/addcomment/:id', loginRequired, workoutController.addCommentController);
workoutRouter.patch('/deletecomment/:id', loginRequired, workoutController.deleteCommentController);
